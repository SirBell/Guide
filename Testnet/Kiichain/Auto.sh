...
NODE_HOME=~/.kiichain3
NODE_MONIKER=Nodevism
SERVICE_NAME=kiichaind
SERVICE_VERSION="v1.3.0"
KIICHAIN_PORT="21"  # Custom port for the KIICHAIN
# ***
...
echo "Setting custom ports in app.toml..."
...
echo "Setting custom ports in config.toml..."
...
# Create the service at /etc/systemd/system/kiichaind.service
echo "Creating $SERVICE_NAME.service at /etc/systemd/system/$SERVICE_NAME.service..."

# Create systemd unit file for kiichaind service
...
[Service]
User=testnet
WorkingDirectory=/home/testnet/.kiichain3
ExecStart=/home/testnet/go/bin/cosmovisor run start
Restart=on-failure
RestartSec=3
LimitNOFILE=65535
Environment="DAEMON_HOME=/home/testnet/.kiichain3"
